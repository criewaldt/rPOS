...
class nPOS:
    ...
    def createDb(self,):
        ...
        try:
            ...
            print('[db] No sqlite3 DBs found. Creating them now.')
    ...
    def checkoutSession(self, userId):
        print("[rPOS] [Checkout] Initiated by: {}".format(userId))

        #do something
        print("[rPOS] [Checkout] [Success] All important stuff confirmed. Session complete for: {}".format(userId))
